...
client.on('message', async message => {
    ...
    if(command === "say") {
        if(!person.roles.cache.has('574425416467742720')) {
            message.channel.bulkDelete(1);
    ...
    if(command === "help") {
        ...
        message.author.send(`Thank you for playing at **Gooks Roleplay Indonesia**, for Problem that you occur at town, please go to: \n-**__CUSTOMER SERVICE CHANNEL__**. \n-**__CUSTOMER SERVICE VOICE CHAT__**.\n\n For <@735928104882667560> BOT problem, please tag ` + "**<@360978552184897547> or go to <#729907171776528474>**");
    }
    ...
    if(command === "names") {
        ...
        if(!person.hasPermission('ADMINISTRATOR')) {
            console.log(`${colors.red(`${message.author} is trying to use players command!`)}`);
            return message.author.send(`**Hei ${message.author}, You did not have permissions to use this command!`);
        }
        else {
    ...
    data.then(pl => {
        ...
        const data = new discord.MessageEmbed()
            ...
            .setTimestamp()
            .setFooter('This data will refreshed every 1 minute', 'https://logodix.com/logo/1609871.png');
    ...
    if(command === 'test') {
        ...
        if(person.roles.cache.has('743511468539904010')) {
            ...
            if(message.channel.id !== "747218989184450702") {
                message.author.send('You send the message in the wrong place! Try it again after you read the instructions!');
            }
            else {
